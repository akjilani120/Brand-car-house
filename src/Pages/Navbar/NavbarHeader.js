...
import { faHeartCirclePlus,  faCartShopping } from '@fortawesome/free-solid-svg-icons';
const NavbarHeader = () => {
    return (
            ...
            <div className='container'>
                <div className='header-main d-flex justify-content-between text-center  align-items-center '  >
                    ...
                    <div className='head-item icon-title d-flex text-center text-center py-3 align-items-center '>
                       ...
                       <p> <Link className="nav-item-link link-icon" to='/myOrder'><span><FontAwesomeIcon className='header-icon' icon={faCartShopping } /></span> 
