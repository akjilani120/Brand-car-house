...
const SpecialCarDataAdd = () => {
    const handlePopulerData =(event) =>{
        ...
        const accelerat = event.target.accelerat.value
       ...
       .then(res => res.json())
       .then(data  => {
        toast("Update and Spcial  car Data Add")
                ...
                <div className='form-head'>
                    <form onSubmit={handlePopulerData} >                         
                       ...
                       <input type="text"   placeholder='Image Link' name='image' required />                          
                          ...
                          <div className='input-items '>                                
                          <input type="text" placeholder='Accelerat' name='accelerat' required />                             
                          ...
                          <div className='input-items '>                                
                          <input type="text" placeholder='Production' name='production' required />                             
...
export default SpecialCarDataAdd;